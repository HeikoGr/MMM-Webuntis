 ...
 */
function calculateFetchRanges(student, config, baseNow, wantsGridWidget, wantsLessonsWidget, fetchExams, fetchAbsences) {
...
module.exports = {
  ...
  compactHolidays,
  formatDateFromYmd,
  // Backward-compatible alias; prefer formatDateFromYmd for backend code clarity.
  formatDate: formatDateFromYmd,
