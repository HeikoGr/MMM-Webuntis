...
function writeRawDump({ server, dataType, payload, suffix = '', logger, logPrefix }) {
  try {
    ...
    logWithStudentContext(logger, 'warn', `${logPrefix} Failed to write raw API dump: ${dumpErr?.message ? dumpErr.message : dumpErr}`);
  }
}
...
const TIMETABLE_POSITION_KEYS = ['position1', 'position2', 'position3', 'position4', 'position5', 'position6', 'position7'];
