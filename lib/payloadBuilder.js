...
function buildGotDataPayload(params) {
  ...
  // Do not warn on an empty timetable. Empty lesson ranges are valid on weekends,
  // holidays, and other schedule gaps, so this warning created false positives.
