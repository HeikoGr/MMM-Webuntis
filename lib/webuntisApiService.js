 ...
 */
async function getHomework({ getAuth, onAuthError, server, rangeStart, rangeEnd, studentId, logger, debugApi = false, dumpRaw = false }) {
  const params = {
    startDate: formatDateYYYYMMDD(rangeStart),
    endDate: formatDateYYYYMMDD(rangeEnd),
  };
 ...
 */
async function getAbsences({ getAuth, onAuthError, server, rangeStart, rangeEnd, studentId, logger, debugApi = false, dumpRaw = false }) {
  const params = {
    startDate: formatDateYYYYMMDD(rangeStart),
    endDate: formatDateYYYYMMDD(rangeEnd),
    studentId: studentId ?? -1,
