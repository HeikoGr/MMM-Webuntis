 ...
 *
 * @example
 * toMinutesSinceMidnight("07:50") // 470
 * toMinutesSinceMidnight(750)      // 470
 * toMinutesSinceMidnight("14:55") // 895
 * toMinutesSinceMidnight(1455)     // 895
 */
 ...
 *
 * @example
 * formatHHMMTime(750)      // "07:50"
 * formatHHMMTime("750")   // "07:50"
 * formatHHMMTime("7:50")  // "7:50"
 * formatHHMMTime(1455)     // "14:55"
 */
function formatHHMMTime(time) {
 ...
 * @returns {string} Date string in YYYY-MM-DD format (ISO 8601)
 *
 * @example
 * formatDateToISO(new Date('2025-12-17')) // "2025-12-17"
 */
