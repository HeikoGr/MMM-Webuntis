...
const {
  ...
  sanitizeRichText,
  compactTimegrid,
} = require("../webuntis/dataOrchestration");
...
const schemas = {
  ...
  exam: {
    ...
    name: { from: "name", transform: (v) => richTextToPlainText(v, false), default: "" },
    subject: { from: "subject", transform: (v) => richTextToPlainText(v, false), default: "" },
    teachers: { from: "teachers", transform: (v) => (Array.isArray(v) ? v.slice(0, 2) : []), default: [] },
    text: { from: "text", transform: (v) => richTextToPlainText(v, true), default: "" },
  },
  homework: {
    id: { from: "id", default: null },
    ...
    text: {
      ...
      transform: (v) => richTextToPlainText(v, true),
      default: "",
    },
    remark: { from: "remark", transform: (v) => richTextToPlainText(v, false), default: "" },
    subject: {
      from: "subject",
  ...
  absence: {
    ...
    reason: {
      ...
      transform: (v) => richTextToPlainText(v, false),
      default: "",
    },
