...
const CHANGED_FIELD_NAME_MAP = Object.freeze({
  su: 'subject',
  te: 'teacher',
  ro: 'room',
  cl: 'class',
...
const schemas = {
  lesson: {
    ...
    substitutionText: { from: 'substText', default: '' },
    lessonText: { from: 'lstext', default: '' },
    ...
    changedFields: {
      from: 'changedFields',
      transform: (v) => (Array.isArray(v) ? v.map((field) => CHANGED_FIELD_NAME_MAP[field] || field).filter(Boolean) : []),
      default: [],
    },
  },
  dayNotice: {
