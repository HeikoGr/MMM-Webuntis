...
class AuthService {
  ...
  buildRestTargets(student, moduleConfig, school, server, ownPersonId, bearerToken = null, appData = null, role = null) {
    ...
    const effectiveRole = role || this._extractRoleFromAppData(appData);
    ...
    if (effectiveRole === 'TEACHER') {
      ...
      if (!effectiveStudentId && ownPersonId) {
        ...
        } else if (effectiveRole === 'STUDENT' || !isParentLogin) {
    ...
    if (effectiveRole === 'LEGAL_GUARDIAN' && effectivePersonId !== ownPersonId) {
