Module.register('MMM-Webuntis', {
  ...
  defaults: {
    ...
    plugins: {
      lessons: {
        enabled: true, // Render lessons list by default.
        config: {
          nextDays: 2, // Number of future days shown in lessons.
          pastDays: 0, // Number of past days kept in the list.
          dateFormat: 'EEE', // Day heading format for lessons.
          hideWeekends: false, // Hide weekend rows when possible.
          showStartTime: false, // Show clock time instead of period labels.
          showRegular: false, // Include regular lessons, not only irregular changes.
          useShortSubject: false, // Prefer short subject labels if available.
          showTeacherMode: 'full', // Teacher rendering mode: off, initial, full.
          showRoom: false, // Display room information in lesson rows.
          showSubstitution: false, // Display substitution text/details.
          naText: 'N/A', // Fallback text for missing lesson values.
        },
      },
      exams: {
        enabled: true, // Render exams list by default.
        config: {
          nextDays: 21, // Number of upcoming days scanned for exams.
          pastDays: 0, // Number of past days kept for recently finished exams.
          dateFormat: 'EEE dd.MM.', // Date display format for exam entries.
          showSubject: true, // Show subject prefix before exam name.
          showTeacher: true, // Show primary teacher for each exam.
        },
      },
      homework: {
        enabled: false, // Disabled by default; enable when homework is needed.
        config: {
          nextDays: 28, // Number of upcoming days scanned for homework.
          pastDays: 0, // Number of past days kept for overdue homework.
          dateFormat: 'EEE dd.MM.', // Due-date display format.
          showSubject: true, // Show subject label for homework entries.
          showText: true, // Show homework description/details.
        },
      },
      absences: {
        enabled: false, // Disabled by default; enable when absence tracking is needed.
        config: {
          pastDays: 21, // Number of historical days shown for absences.
          nextDays: 7, // Number of upcoming days considered for planned absences.
          dateFormat: 'EEE dd.MM.', // Date display format for absence rows.
          showDate: true, // Show absence date column.
          showExcused: true, // Show excused/unexcused state.
          showReason: true, // Show reason text if provided.
          maxItems: null, // Optional max row count, null means unlimited.
        },
      },
      messagesofday: {
        enabled: false, // Disabled by default; enable to show daily messages.
        config: {}, // No plugin-specific options yet.
      },
      grid: {
        enabled: false, // Disabled by default; enable for timetable grid view.
        config: {
          nextDays: 4, // Number of future days displayed in the grid.
          pastDays: 0, // Number of past days shown before today.
          weekView: false, // Force Monday-Friday week layout.
          dateFormat: 'EEE dd.MM.', // Day header format inside the grid.
          hideWeekends: false, // Hide weekend columns when possible.
          showNowLine: true, // Show live current-time marker.
          mergeGap: 15, // Merge adjacent lessons when gap is within minutes.
          maxLessons: 0, // Limit visible periods, 0 means unlimited.
          naText: 'N/A', // Fallback text for missing cell values.
          fields: {
            primary: 'subject', // Primary field rendered in each lesson cell.
            secondary: 'teacher', // Secondary field rendered below primary.
            additional: ['room'], // Extra fields appended in brackets.
            format: {
              subject: 'long', // Subject label mode.
              teacher: 'long', // Teacher label mode.
              class: 'short', // Class label mode.
              room: 'short', // Room label mode.
              studentGroup: 'short', // Student-group label mode.
            },
          },
        },
      },
